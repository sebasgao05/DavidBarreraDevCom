...
const Experience: React.FC = () => {
  ...
  const { experience, volunteer, education } = usePortfolioData();

  const renderExperienceSection = (experiences: ExperienceItem[], title: string) => (
    <div className="relative">
      {/* Continuous timeline line */}
      <div className="absolute left-6 top-6 w-0.5 bg-primary-200 dark:bg-primary-800" 
        ...
        {experiences.map((exp: ExperienceItem, index: number) => (
          <div key={index} className="relative">
            <div className="flex gap-4">
              {/* Timeline dot */}
              <div className="flex-shrink-0 w-12 h-12 bg-primary-600 rounded-full flex items-center justify-center z-10">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  {exp.profileUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 rounded-full text-xs font-medium hover:bg-orange-200 dark:hover:bg-orange-900/50 transition-colors duration-200"
                    >
      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {renderExperienceSection(experience, t('experience.workExperience'))}
          </div>

          {/* Volunteer Experience */}
          <div>
            <h3 className="text-2xl font-bold mb-8 text-gray-900 dark:text-gray-100">
              {t('experience.volunteerExperience')}
            </h3>
            {renderExperienceSection(volunteer, t('experience.volunteerExperience'))}
          </div>
        </div>
